!(function(e, n) {
    ...
    n &&
      u.push({
        ...
        data: function(e, n) {
          ...
          return t.setHSL(e / n, 0.6, 0.7), [t.r, t.g, t.b];
        },
        size: 3
      });
    var c =
  ...
  t.setClearColor(2171169, 0),
    t.setSize(window.innerWidth, window.innerHeight),
    t.setPixelRatio(window.devicePixelRatio >= 2 ? 2 : 1),
  ...
  var r = new THREE.AmbientLight("#ffffff", 0.1);
  i.add(r);
  var a = new THREE.SpotLight(16777215, 1, 80, 0.25 * Math.PI, 1, 2);
  function s() {
    t.render(i, o);
  }
  function u(e) {
    return "#" + new THREE.Color().setHSL(e, 0.5, 0.5).getHexString();
  }
      ...
      m = function(e) {
        ...
        uos(n, t, function(n) {
          ...
          uos(t, i, function(n) {
            var t = 2 * n - 1;
            (t = 1 - t * t),
              (l[e].style.opacity = e === c.length - 1 ? 1.5 * n : 1.5 * t);
          });
      },
      v = 0;
    v < c.length;
  ...
  function h() {
    (o.aspect = window.innerWidth / window.innerHeight),
      ...
      t.setSize(window.innerWidth, window.innerHeight);
    for (
      var e = document.querySelectorAll(".heading"), n = 0;
      n < e.length;
      n += 1
    )
      e[n].style.height = window.innerHeight + "px";
    s();
  }
